 ...
 * @author Yasin
 */
public class BeeindigTaak extends javax.swing.JFrame {
    ...
    private User2 user;
    public BeeindigTaak(User2 user, ArrayList<Taak> takenlijst,ArrayList<User2> users,ArrayList<Groep> groepen) {
        initComponents();
        this.user=user;
